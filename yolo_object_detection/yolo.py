...
class YOLO(object):
    _defaults = {
        ...
        "model_path": 'model_data/nike_derived_model.h5',           # 2-1) to test the raccoon_dataset_derived_model
        "anchors_path": 'model_data/yolo_anchors.txt',
        # "classes_path": 'model_data/coco_classes.txt',
        "classes_path": 'Apparel_Dataset/apparel_classes.txt',         # 2-2) to test the raccoon_dataset_derived_model
        "score" : 0.3,
        "iou" : 0.45,
