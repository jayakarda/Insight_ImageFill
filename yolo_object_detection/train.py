...
if __name__ == '__main__':
    ...
    parser.add_argument("-a", "--annotation_path", type=str, default='./Apparel_Dataset/nike_train_data.txt', help="input annotation_path")
    parser.add_argument("-c", "--classes_path", type=str, default='model_data/apparel_classes.txt', help="input classes_path")
    parser.add_argument("-o", "--output_model_path", type=str, default='model_data/apparel_model.h5', help="input output_model_path")
