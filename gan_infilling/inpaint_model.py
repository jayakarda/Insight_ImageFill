...
class InpaintCAModel(Model):
    ...
    def build_graph_with_losses(self, batch_data, config, training=True,
        ...
        #Jaya's Code
        # file_path ='/Users/jayakarda/Downloads/generative_inpainting-master/bbox_coordinates.txt'
        # bbox_entries = process_yolo_output.read_output(file_path)
        # bbox_list=  process_yolo_output.create_bbox(bbox_entries)
